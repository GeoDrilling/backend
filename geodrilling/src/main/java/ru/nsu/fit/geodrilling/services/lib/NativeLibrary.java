...
public class NativeLibrary {
    ...
    public native OutputModel SolverHorizontalModel6Param1_5DByRo(
            ...
            double ro_up, double min_ro_up, double max_ro_up,
            double kanisotropy_up, double min_kanisotropy_up, double max_kanisotropy_up,
            double ro_down, double min_ro_down, double max_ro_down,
            double kanisotropy_down, double min_kanisotropy_down, double max_kanisotropy_down
    );
    ...
    public OutputModel solverModel(InputBuildModel model) {
        return SolverHorizontalModel6Param1_5DByRo(
                ...
                model.ro_up, model.min_ro_up, model.max_ro_up,
                model.kanisotropy_up, model.min_kanisotropy_up, model.max_kanisotropy_up,
                model.ro_down, model.min_ro_down, model.max_ro_down,
                model.kanisotropy_down, model.min_kanisotropy_down, model.max_kanisotropy_down
        );
    }
